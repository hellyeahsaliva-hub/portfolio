...
geral
 ...
 Estruturação de pastas e documentação


 O que você vai encontrar aqui

Projetos **front-end**, **back-end** e **fullstack**
Aplicações consumindo APIs externas
Projetos focados em resolver problemas reais
Código comentado e organizado

Cada projeto possui seu próprio README com detalhes sobre funcionamento, tecnologias utilizadas e instruções de execução.
...
Busco oportunidades para:
 ...
 Contribuir com soluções eficientes e bem estruturadas
